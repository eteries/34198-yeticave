...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            <?php foreach($lots as $lot_key => $lot_value): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src=<?=$lot_value['img'];?> width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$lot_value['category'];?></span>
                    <h3 class="lot__title"><a class="text-link" href=""><?=$lot_value['title'];?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$lot_value['price'];?><b class="rub">р</b></span>
                        </div>
